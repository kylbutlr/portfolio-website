...
export default () => (
  <div className='bio'>
    <p>
      ...
      small business&nbsp;and&nbsp;personal websites to intuitive progressive&nbsp;web&nbsp;applications.
    </p>
    <p>
      ...
      <span className='bold'>Bulma</span>, <span className='bold'>Bootstrap</span>), Version Control
      Systems (<span className='bold'>Github</span>, <span className='bold'>Git</span>
